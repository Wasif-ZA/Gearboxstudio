...
export function Hero() {
    ...
    return (
        <section className="relative w-full flex flex-col items-center bg-[#FAFAFA] overflow-hidden font-sans selection:bg-lime-200 pt-24 pb-32 md:pt-32 md:pb-48">
            ...
            {/* --- AMBIENT GLOWS --- */}
            <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] bg-[#d9f99d] rounded-full blur-[150px] opacity-20 pointer-events-none mix-blend-multiply" />
            <div className="absolute top-[10%] right-[-15%] w-[60vw] h-[60vw] bg-emerald-100 rounded-full blur-[150px] opacity-30 pointer-events-none mix-blend-multiply" />
            ...
            >
                <div className="relative bg-white rounded-xl md:rounded-[1.5rem] border border-slate-200 shadow-2xl shadow-slate-200/50 flex flex-col md:flex-row overflow-hidden ring-4 ring-white/50 h-[600px] md:h-auto">

                    {/* --- SIDEBAR (Interactive) --- */}
                    <div className="hidden md:flex flex-col w-64 border-r border-slate-100 bg-slate-50/50 p-5 gap-2 shrink-0">
                        <div className="flex items-center gap-3 px-2 mb-6">
                            <div className="w-8 h-8 bg-gradient-to-br from-emerald-800 to-lime-600 rounded-lg flex items-center justify-center text-white font-bold text-xs shadow-sm">TP</div>
                            <span className="text-base font-bold text-slate-800 tracking-tight">Topi</span>
                        </div>
                    ...
                    <div className="md:hidden flex items-center justify-between p-4 border-b border-slate-100 bg-white z-10">
                        <div className="flex items-center gap-2">
                            <div className="w-7 h-7 bg-emerald-800 rounded-md flex items-center justify-center text-white text-[10px] font-bold">TP</div>
                            <span className="font-bold text-slate-800">Topi</span>
                        </div>
                    ...
                    <div className="flex-1 bg-white relative flex flex-col h-full overflow-hidden">
                        ...
                        <div className="flex items-center justify-between p-6 md:p-8 border-b border-slate-50">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="w-8 h-8 bg-slate-100 rounded-full border border-slate-100 overflow-hidden ml-1">
